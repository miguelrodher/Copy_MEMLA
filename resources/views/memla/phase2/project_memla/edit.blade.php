...
<div>
    ...
    <div class="flex flex-col items-center min-h-screen pt-6 bg-white-900 sm:justify-center sm:pt-0">


        <div class="w-full px-16 py-20 mt-6 overflow-hidden bg-white rounded-lg lg:max-w-4xl">
            <div class="mb-4">
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl md:text-4xl">
                    <spa class="block text-memla-900" >Edit project</spa>
                </h1>
            </div>

            <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                <form method="POST" action="{{route('project_memla.update',$projectMemla)}}">
                    @csrf
                    @method('PUT')
                    <!-- Title -->
                    <div>
                        ...
                        <input
                            ...
                            type="text" name="title" placeholder="180" value=" {{$projectMemla->title}}" />
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="description"
                                  class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                  rows="4" placeholder="400">{{$projectMemla->description}}</textarea>
                    </div>
                    ...
                    <div class="flex items-center justify-start mt-4 gap-x-2">
                        ...
                        <a type="button" href="{{url("project_memla")}}"
                                class="inline-flex px-4 py-2 font-medium text-center text-white rounded-md shadow bg-gradient-to-r from-memla-800 to-memla-900 hover:from-memla-200 hover:to-memla-300 hover:text-gray-600">
                            Back
                        </a>
                    </div>
